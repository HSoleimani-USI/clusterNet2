...
FILES_CPP := $(ROOT_DIR_CCP)/fooclass.cpp $(ROOT_DIR_CCP)/pythonWrapper.c $(ROOT_DIR_CCP)/pythonInterface.c
...
all:	
	...
	g++ -std=c++11 -shared -fPIC $(INCLUDE) $(BUILD_DIR)/basicOps.o $(BUILD_DIR)/clusterKernels.o $(BUILD_DIR)/link.o $(FILES_CPP) -o $(ROOT_DIR)/lib/libfoo.so $(LIB) -lboost_system -lboost_date_time -lboost_thread 	
	g++ -std=c++11 $(INCLUDE)  -L $(ROOT_DIR)/lib $(ROOT_DIR)/main.cpp -o main.o $(LIB) -lfoo  -lboost_system 
clean:
