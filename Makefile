...
FILES_CPP := $(ROOT_DIR_CCP)/ClusterNet.cpp $(ROOT_DIR_CCP)/pythonWrapper.c $(ROOT_DIR_CCP)/pythonInterface.c $(ROOT_DIR_CCP)/BatchAllocator.cpp $(ROOT_DIR_CCP)/Layer.cpp $(ROOT_DIR_CCP)/NeuralNetwork.cpp
...
all:	
	...
	g++ -std=c++11 -shared -fPIC $(INCLUDE) $(BUILD_DIR)/basicOps.o $(BUILD_DIR)/clusterKernels.o $(BUILD_DIR)/Timer.o  $(BUILD_DIR)/link.o $(FILES_CPP) -o $(ROOT_DIR)/lib/libClusterNet.so $(LIB) 	
