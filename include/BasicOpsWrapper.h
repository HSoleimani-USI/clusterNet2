...
public:
	...
	template <int action> void elementWise(Matrix<float> *A, Matrix<float>*out, float scalar) = 0;
	template <int action> void elementWise(Matrix<float> *A, Matrix<float> *B, Matrix<float>*out) = 0;
	template <int action> void elementWise(Matrix<float> *A, Matrix<float> *B, Matrix<float>*out, float scalar) = 0;

	template <int action> void vectorWise(Matrix<float> *v, Matrix<float>*out) = 0;
	template <int action> void vectorWise(Matrix<float> *A, Matrix<float> *v, Matrix<float>*out) = 0;
	*/
